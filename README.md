...
background-color: rgba(8, 1, 1, 0.637);
...
<br>
    ...
    <input type="text" id="name" maxlength="20" minlength="4" required>
    <br>
    <br>
    <label for="father">Father Name :</label>
    <input type="text" id="father" maxlength="20" minlength="4" required>
    <br><br>
    <label for="age" >Age :</label>
    <input type="number" id="age" maxlength="2" minlength="2" required>
    <br><br>
